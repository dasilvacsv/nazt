...
CREATE TABLE EMPLEADO (
	...
	correo_e VARCHAR(35),
	id_parr_id INTEGER NOT NULL,
	pantalon_e VARCHAR(3),
	camisa_e VARCHAR (3),
	botas_e VARCHAR(2),
	direccion_e VARCHAR(25) NOT NULL,
	tipo_personal_e VARCHAR(1),
	jornada_e VARCHAR(10),
	geo_ubicacion VARCHAR(50),
	reg_fotog_e VARCHAR(50) NOT NULL,
	reg_biometrico_e VARCHAR(60) NOT NULL,
	id_emp_carg INTEGER NOT NULL,
